...
function Accounts({navigation}) {
  ...
  const data = [
    ...
    },
    {
      ...
      sign: '-',
      image:
        'https://ilyasbat.com.tr/react-native-ders/icons/entertaintment.png',
      key: '8',
    },
  ];
  return (
          ...
          <View
            ...
            <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
              <View
                style={{
                  backgroundColor:
                    'rgba(' + colors.secondaryBackgroundColorRgba + ', .2)',
                  width: 34,
                  height: 34,
                  borderRadius: 34,
                  alignItems: 'center',
              ...
              <Text style={{fontSize: 20, color: colors.black, opacity: 0.8}}>
                {item.name}
              </Text>
            </View>
