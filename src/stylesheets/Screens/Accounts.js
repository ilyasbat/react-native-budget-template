...
const styles = StyleSheet.create({
    ...
    imageNoHorizontalMargin:{width: 24, height: 24, marginVertical: 10, tintColor: colors.primaryTintColor},
    flatlist:{marginTop:5,flex:1},
    itemContainer:{marginHorizontal:16,marginTop:8,backgroundColor:colors.primaryTintColor,borderRadius:8,minHeight:82,padding:12},
